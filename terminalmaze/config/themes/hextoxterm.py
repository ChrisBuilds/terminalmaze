...
def main():
    ...
    while True:
        try:
            print("Enter a hex color code or <ctrl-c> to quit.")
            color_string = input("Color:").strip("#")
            closest = sorted(
                list(
                    (
                        xterm_color,
            ...
            print(f"Target Color Hex: #{color_string}")
            print(f"Closest xterm: {closest} = {colored.fg(closest)}{chr(9608)*10}{colored.attr('reset')}")
